...
class DutchieBannerCarousel {
    ...
    public function shortcode_banners($atts) {
        ...
        foreach ($banners as $b) {
            ...
            if (!empty($b['link'])) $o .= '<a href="' . esc_url($b['link']) . '" target="_blank" rel="noopener" style="display:block;max-width:100%">';
    ...
    public function output_styles() {
        echo '<style>
.dutchie-carousel{position:relative;overflow:hidden!important;max-width:100%;width:100%;cursor:grab;touch-action:pan-y pinch-zoom;-webkit-user-select:none;user-select:none;box-sizing:border-box}
