...
class DutchieBannerCarousel {
    ...
    public function shortcode_banners($atts) {
        ...
        foreach ($banners as $b) {
            ...
            $o .= '<img src="' . esc_url($b['src'] ?? '') . '" alt="' . esc_attr($b['alt'] ?? '') . '" loading="lazy" draggable="false" style="width:100%!important;max-width:100%!important;height:auto!important;display:block">';
            if (!empty($b['link'])) $o .= '</a>';
            $o .= '</div>';
        }
...
.dutchie-slide img{width:100%!important;max-width:100%!important;height:auto!important;display:block;pointer-events:none;-webkit-user-drag:none;object-fit:contain}
